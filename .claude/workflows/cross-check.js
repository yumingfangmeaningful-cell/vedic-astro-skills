...
按要素逐项解读——不是罗列数据，而是每项都解释"在什么位置、意味着什么"。用表格呈现数据+文字展开解读。
...
逐学派/逐层展开推理，先给依据再给结论：
- 先列出判断依据（如旺衰四步、格局取法、串联条件）
- 再给出判断结论
- 对每个结论标注学派来源、数据质量、证据强度
- 有内部矛盾时并列呈现，不强行调和
- 可加入「📚 知识卡片」解释关键概念

# 第三部分：逐维度分析

对每个指定维度——结论 + 2–4条盘面依据（解释为什么） + 现实表现 + 限制/反例。
标注学派来源、数据质量、证据强度。
